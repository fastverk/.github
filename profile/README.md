<!--
  ...
  from the live state of tomato-bazel/bazel-registry plus GitHub
...
Live sources are under [tomato-bazel](https://github.com/tomato-bazel). Modules already imported into the [rules](https://github.com/tomato-bazel/rules) git vehicle are linked there; the rest still live as `tomato-bazel/rules_*` repos.

- **Language toolchains** — [rules_uv](https://github.com/tomato-bazel/rules_uv), [rules_lean](https://github.com/tomato-bazel/rules_lean), [rules_postgres](https://github.com/tomato-bazel/rules_postgres), [rules_autoconf](https://github.com/tomato-bazel/rules_autoconf)
- **API + schema** — [rules_jsonschema](https://github.com/tomato-bazel/rules/tree/main/rules_jsonschema), [rules_openapi](https://github.com/tomato-bazel/rules/tree/main/rules_openapi)
- **Web + bundlers** — [rules_bun](https://github.com/tomato-bazel/rules_bun), [rules_chrome](https://github.com/tomato-bazel/rules_chrome), [rules_nextjs](https://github.com/tomato-bazel/rules_nextjs), [rules_storybook](https://github.com/tomato-bazel/rules_storybook), [rules_vite](https://github.com/tomato-bazel/rules_vite), [rules_docker_compose](https://github.com/tomato-bazel/rules_docker_compose)
- **CI + cloud** — [rules_github](https://github.com/tomato-bazel/rules/tree/main/rules_github), [rules_gitlab](https://github.com/tomato-bazel/rules_gitlab), [rules_ci](https://github.com/tomato-bazel/rules/tree/main/rules_ci), [rules_cloudformation](https://github.com/tomato-bazel/rules_cloudformation)
- **Docs + publishing** — [rules_mdbook](https://github.com/tomato-bazel/rules/tree/main/rules_mdbook), [rules_tectonic](https://github.com/tomato-bazel/rules_tectonic)
- **Semantic web** — [rules_jena](https://github.com/tomato-bazel/rules/tree/main/rules_jena), [rules_rdf](https://github.com/tomato-bazel/rules/tree/main/rules_rdf)
...
- **[bazel-registry](https://github.com/tomato-bazel/bazel-registry)** —
