<!--
  ...
  bounded by `<!-- BOTNOC:* -->` ... `<!-- /BOTNOC:* -->` are
  rewritten in-place by that tool from the live state of
  fastverk/bazel-registry + GitHub repo descriptions. Everything
  else is hand-authored — feel free to edit.

  Regenerate locally:
      cd ../botnoc && cargo run -p botnoc-readme -- \
